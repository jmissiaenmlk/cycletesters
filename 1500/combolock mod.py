...
class App:
    ...
    motor1Travel = int(input("combo 1: "))
    motor2Travel = int(input("combo 2: "))
    motor3Travel = int(input("combo 3: "))
    motor4Travel = int(input("numbers to zero: "))
   
    cycle = int(input("Enter Number Of Cycles: "))
    fail = 0
    failtest = 0
# gpio 26 direction - 19 pulse
    while cycle >= 0:
        print("cycle",cycle)
