...
prompt1 = int((input("Turn motor power switch OFF and press ENTER")))
prompt2 = int((input("Manually turn dial to ZERO position and press ENTER")))
prompt3 = int((input("Turn motor power switch ON and press ENTER")))
